...
public class TutorialManager : MonoBehaviour
{
    ...
    private PlayerControllerPC playerControllerPC;
    ...
    private void Start() 
    {
        playerControllerPC = FindObjectOfType<PlayerControllerPC>();
    ...
    void TutMove()
    {
        if(playerControllerPC.iAmMoving)
        {
            state = 1;
